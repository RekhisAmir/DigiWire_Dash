                              ...
                              elseif(($t>strtotime("14:00:00"))&($t<strtotime("22:00:00"))){
                               ...
                               elseif(($t>strtotime("00:00:00"))&($t<strtotime("06:00:00"))){
                                //    echo("3rd shift");
                                   ...
                                   $OK1=$tab[count($tab)-1]['OK'];
                                   $NOK1=$tab[count($tab)-1]['NOK'];
                                ...
                                if(($t>strtotime("06:00:00"))&($t<strtotime("14:00:00"))){
                                 //    echo("1st shift");
                                    ...
                                    while ($item = $rslt1->fetch_assoc()){ $tab[] = $item; };
                                        ...
                                        $presence_in=$tab[0]['p_count'];
                                        $presence_out=$tab[1]['p_count'];
                                    
                                    $presence = $presence_in - $presence_out;
                                ...
                                elseif(($t>strtotime("00:00:00"))&($t<strtotime("06:00:00"))){
                                 //    echo("3rd shift");
                                    ...
                                    while ($item = $rslt4->fetch_assoc()){ $tab[] = $item; };
                                        ...
                                        $presence_in1=$tab[0]['p_count'];
                                        $presence_out1=$tab[1]['p_count'];
                                    ...
                                    while ($item = $rslt5->fetch_assoc()){ $tab5[] = $item; };
                                        ...
                                        $presence_in2=$tab5[0]['p_count'];
                                        $presence_out2=$tab5[1]['p_count'];
                                    
                                    
 
                                  $presence_in=$presence_in1+$presence_in2;
                                  $presence_out=$presence_out1+$presence_out2;
